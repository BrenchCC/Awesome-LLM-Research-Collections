...
![第一代 Qwen 技术报告 Figure 1：预训练基座分化为 Chat、代码、数学、视觉语言和 RLHF 模型。图像由论文 PDF 矢量页以 300 DPI 以上裁切。](../../assets/from-qwen-to-qwen3-6/qwen-model-lineage.png){fig-alt="Qwen 技术报告中的模型谱系图，展示 Qwen 基座、Qwen-Chat、Qwen-RM、Qwen-Chat-RLHF、Code-Qwen、Math-Qwen-Chat 与 Qwen-VL"}
