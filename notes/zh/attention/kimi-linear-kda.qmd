...
*来源：[Kimi Linear](https://arxiv.org/abs/2510.26692)，Figure 1，第 1 页。*
...
![Softmax/MLA 的随序列增长缓存与 KDA 固定状态记忆对照。](../../assets/kimi-linear-kda/attention-memory-cost.svg){fig-alt="对比 Softmax 或 MLA 按 token 增长的 KV 缓存、KDA 固定矩阵状态，以及 Kimi Linear 的三比一混合结构"}

*依据 [Kimi Linear](https://arxiv.org/abs/2510.26692) §3–§4 与发布模型配置。*
...
*公式依据 [Kimi Linear](https://arxiv.org/abs/2510.26692) §2–§3 与 [Gated DeltaNet](https://arxiv.org/abs/2412.06464)。*
...
![KDA 单步状态更新中的通道衰减、定向擦除、关联写入和查询读出。](../../assets/kimi-linear-kda/kda-state-edit.svg){fig-alt="KDA 状态编辑图，依次展示通道级 alpha 衰减、beta 与键方向控制的擦除、键值外积写入和查询读出"}
...
*来源：[Kimi Linear](https://arxiv.org/abs/2510.26692)，Figure 2，第 5 页。*
...
*依据论文 §3.2、附录算法与 FLA 的 KDA kernel 路径。*
...
*来源：[Kimi Linear](https://arxiv.org/abs/2510.26692)，Figure 4，第 7 页。*
...
*来源：[Kimi Linear](https://arxiv.org/abs/2510.26692)，Table 1，第 8 页。*
...
*来源：[Kimi Linear](https://arxiv.org/abs/2510.26692)，Figure 5，第 9 页。*
...
*来源：[Kimi Linear](https://arxiv.org/abs/2510.26692)，Table 5，第 12 页。*
...
*来源：[Kimi Linear](https://arxiv.org/abs/2510.26692)，Figure 6，第 12 页。*
...
*来源：[Kimi Linear](https://arxiv.org/abs/2510.26692)，Figure 7，第 13 页。*
...
FlashKDA 把 kernel 优化继续往下推进。官方说明采用 CUTLASS、较小的 chunk 16、两个主 kernel，并用 BF16 保存状态、FP32 FMA 累加。下图汇总官方 H20 表格，六个 $T=8192,d=128$ 工作负载相对 FLA KDA 为 1.85–2.31 倍。它是算子延迟，不含整个 Transformer 层。

![FlashKDA H20 benchmark 中 FLA 与 FlashKDA 的延迟和加速比对照。](../../assets/kimi-linear-kda/flashkda-h20-benchmark.svg){fig-alt="FlashKDA 官方 H20 benchmark 数据，列出 96 头与 64 头下固定长度、混合变长和八乘 1024 工作负载的 FLA 与 FlashKDA 延迟及加速比"}

*数据来源：[MoonshotAI/FlashKDA](https://github.com/MoonshotAI/FlashKDA)，官方 H20 benchmark（2026-04-22）；访问于 2026-08-03。*
...
*来源：[Gated DeltaNet-2](https://arxiv.org/abs/2605.22791)，Figure 1，第 6 页。*
