...
![OpenAI 公布的 GPT‑5.6 自我改进评测分数。来源：2026 年 7 月官方发布页，访问日期：2026-08-21；图中数值均为 OpenAI 内部或官方配置下的结果。](../../assets/recursive-self-improvement/openai-rsi-index-redraw.svg){width="92%" fig-align="center"}
...
![Anthropic 对 AI 研发自动化的五阶段划分。来源：Anthropic Institute 官方页面，访问日期：2026-08-21；“20XX?” 明确表示 closing the loop 仍是未来阶段。](../../assets/recursive-self-improvement/anthropic-rsi-timeline.png){width="62%" fig-align="center"}
...
![Models、Harnesses 与 Artifacts 三类优化对象。该图只描述优化对象，不表示闭环强度。](../../assets/recursive-self-improvement/three-object-taxonomy.png){width="72%" fig-align="center"}
...
![Autoresearch 的自动实验记录：候选修改、固定训练预算、验证指标与保留/丢弃决策。来源：项目公开运行记录。](../../assets/recursive-self-improvement/autoresearch-run.png){width="92%" fig-align="center"}
...
![AlphaEvolve 流程：历史程序采样、LLM 生成、自动评估和进化数据库。来源：Google DeepMind 官方博客。](../../assets/recursive-self-improvement/alphaevolve-loop.webp){width="92%" fig-align="center"}
...
![Harness-updating 与 harness-benefit 的差异：左图显示更新建议能力较平，右图显示不同模型从更新中获益并不单调。](../../assets/recursive-self-improvement/harness-updating-benefit.png){width="92%" fig-align="center"}
...
![MiniMax 公布的 M2 系列研发 Harness：技能、记忆、护栏和评测基础设施连接到实验迭代循环。来源：MiniMax 官方发布页。](../../assets/recursive-self-improvement/minimax-m27-recursive-loop.png){width="90%" fig-align="center"}
...
![Apodex‑1.0 的多 Agent 研究与验证结构。来源：Apodex 官方博客。](../../assets/recursive-self-improvement/apodex-agent-team.avif){width="88%" fig-align="center"}
...
![RHI 循环：运行当前 Harness、比较输出、累积偏好历史并生成下一版 Harness。来源：RHI v1，Figure 2。](../../assets/recursive-self-improvement/rhi-loop.png){width="90%" fig-align="center"}
...
![RHI 对 Harness 的分解：Agent Design，以及由 Contract 与 Hop 构成的 Agent Workflow。来源：RHI v1。](../../assets/recursive-self-improvement/rhi-harness-structure.png){width="84%" fig-align="center"}
...
![Terminal‑Bench 2.1 的预算对等结果。来源：Ai2 论文 v1。](../../assets/recursive-self-improvement/harness-evolution-budget-baselines.png){width="42%" fig-align="center"}
...
![AIDE² 的外层代码改写与逐步准入。来源：Weco AI 官方实验说明；每个候选需超过当前最佳版本才保留。](../../assets/recursive-self-improvement/aide2-self-improvement.png){width="92%" fig-align="center"}
...
![RHO 从历史轨迹到 Harness 更新的流程。来源：RHO v2，Figure 2。](../../assets/recursive-self-improvement/rho-retrospective-harness-pipeline.png){width="94%" fig-align="center"}
...
![HSI 的三层结构：Meta-Evolver、Evolver 与 Task Harness，共享文件系统但拥有不同可编辑面。来源：HSI v1，Figure 1。](../../assets/recursive-self-improvement/hsi-three-level-architecture.png){width="94%" fig-align="center"}
...
![SIA 的两个更新旋钮：Harness 与模型权重。来源：SIA v2。](../../assets/recursive-self-improvement/sia-two-update-levers.png){width="90%" fig-align="center"}

![SIA 的完整循环：Meta-Agent 初始化 scaffold，任务 Agent 执行，Feedback-Agent 在 Harness 与权重更新间选择。来源：SIA v2。](../../assets/recursive-self-improvement/sia-system-loop.png){width="90%" fig-align="center"}
...
![Continual Harness：单局内高频更新 Harness，跨轮次用过程奖励与教师轨迹更新模型。来源：论文 v1。](../../assets/recursive-self-improvement/continual-harness.png){width="94%" fig-align="center"}
...
![HELIX 的双时间尺度：任务内模型与 Harness 交互，跨轮次由验证 sibling data 更新模型，并为新模型重建 Harness。来源：HELIX v1，Figure 1。](../../assets/recursive-self-improvement/helix-two-timescales.png){width="94%" fig-align="center"}
...
![On-policy distillation 的逐 token 教师置信度示例。来源：Thinking Machines 官方博客。](../../assets/recursive-self-improvement/on-policy-distillation-token-confidence.svg){width="72%" fig-align="center"}
...
![图可达性实验中 Coconut、CoT、延长 CoT 与 No-CoT 的准确率。来源：Reasoning by Superposition。](../../assets/recursive-self-improvement/reasoning-by-superposition-results.png){width="38%" fig-align="center"}
