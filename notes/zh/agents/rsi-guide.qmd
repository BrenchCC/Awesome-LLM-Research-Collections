...
description: "从进化对象、版本结构、更新者、更新时机和反馈维度整理 Recursive Self-Improvement（RSI）方法。"
order: 1
...
![codex\-rsi\-taxonomy\-overview\-gpt\-preview\-v1\.png](../../assets/rsi-guide/codex-rsi-taxonomy-overview-gpt-preview-v1.png)

![codex\-rsi\-artifact\-mode\-matrix\-v1\.png](../../assets/rsi-guide/codex-rsi-artifact-mode-matrix-v1.png)

## 1 RSI 到底是什么

本文把 RSI 定义为：Agent 在与环境交互后，利用任务轨迹与反馈，通过更新机制修改自身状态，并让更新后的状态参与后续任务，以提升未来表现。

![codex\-rsi\-loop\-v5\.png](../../assets/rsi-guide/codex-rsi-loop-v5.png)
...
![codex\-agent\-anatomy\-v3\.png](../../assets/rsi-guide/codex-agent-anatomy-v3.png)
...
![01\-seal\-fig1\.png](../../assets/rsi-guide/01-seal-fig1.png)
...
![02\-prime\-agent\-fig1\.png](../../assets/rsi-guide/02-prime-agent-fig1.png)
...
![03\-reasoningbank\-fig2\.png](../../assets/rsi-guide/03-reasoningbank-fig2.png)
...
![04\-trace\-fig2\.png](../../assets/rsi-guide/04-trace-fig2.png)
...
![05\-skillsmith\-fig2\.png](../../assets/rsi-guide/05-skillsmith-fig2.png)
...
![codex\-evolution\-topologies\-v1\.png](../../assets/rsi-guide/codex-evolution-topologies-v1.png)
...
![10\-skillflow\-fig1\.png](../../assets/rsi-guide/10-skillflow-fig1.png)
...
![10\-dgm\-fig3\.png](../../assets/rsi-guide/10-dgm-fig3.png)
...
![11\-mgm\-fig1\.png](../../assets/rsi-guide/11-mgm-fig1.png)
...
![codex\-self\-update\-v1\.png](../../assets/rsi-guide/codex-self-update-v1.png)
...
![codex\-teacher\-update\-v1\.png](../../assets/rsi-guide/codex-teacher-update-v1.png)

**代表工作：**[**Recursive Experiential\-Working Memory Evolution for Long\-Horizon Agent Harnesses**](https://arxiv.org/abs/2608.24876)

![13\-recuris\-fig3\.png](../../assets/rsi-guide/13-recuris-fig3.png)
...
![codex\-joint\-update\-v1\.png](../../assets/rsi-guide/codex-joint-update-v1.png)

**代表工作：**[**Evo\-Harness: Context\-to\-Harness Skill Compilation for Self\-Evolving Agents**](https://arxiv.org/abs/2608.15071)

![14\-evo\-harness\-fig3\.png](../../assets/rsi-guide/14-evo-harness-fig3.png)
...
![codex\-rsi\-update\-timing\-v1\.png](../../assets/rsi-guide/codex-rsi-update-timing-v1.png)
...
![06\-gdpevo\-fig1\.png](../../assets/rsi-guide/06-gdpevo-fig1.png)
...
![09\-finevo\-bench\-fig2\.png](../../assets/rsi-guide/09-finevo-bench-fig2.png)
...
![08\-mem2evolve\-fig2\.png](../../assets/rsi-guide/08-mem2evolve-fig2.png)
