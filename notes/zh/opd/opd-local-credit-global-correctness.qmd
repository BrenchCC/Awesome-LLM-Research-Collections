...
![我对 OPD 的理解从“蒸馏强化学习”演进到局部监督与全局验证分工。图由本文依据 OPD、KAT、BRTS、TrOPD 与 local support matching 的方法整理。](../../assets/opd-local-credit-global-correctness/opd-mental-model-journey-zh.svg){#fig-opd-mental-model-journey-zh fig-align="center" width="94%"}
