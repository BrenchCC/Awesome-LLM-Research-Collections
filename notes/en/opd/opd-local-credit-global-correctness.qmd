...
![The division between local supervision and global correctness verification in OPD. This diagram is synthesized from OPD, KAT, BRTS, TrOPD, and local support matching.](../../assets/opd-local-credit-global-correctness/opd-mental-model-journey-en.svg){#fig-opd-mental-model-journey-en fig-align="center" width="94%"}
