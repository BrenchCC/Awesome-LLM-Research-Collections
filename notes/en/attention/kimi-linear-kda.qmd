...
*Source: [Kimi Linear](https://arxiv.org/abs/2510.26692), Figure 1, page 1; cropped from the vector PDF at approximately 5x/360 DPI.*
...
![Growing Softmax/MLA cache versus KDA fixed-state memory.](../../assets/kimi-linear-kda/attention-memory-cost.svg){fig-alt="Original diagram comparing the token-growing KV cache of Softmax or MLA, KDA's fixed matrix state, and Kimi Linear's three-to-one hybrid"}

*Original diagram based on [Kimi Linear](https://arxiv.org/abs/2510.26692), Sections 3–4, and the released model configuration.*
...
*Original diagram; equations follow [Kimi Linear](https://arxiv.org/abs/2510.26692), Sections 2–3, and [Gated DeltaNet](https://arxiv.org/abs/2412.06464).*
...
![Channel decay, key-directed erase, association write, and query readout in one KDA update.](../../assets/kimi-linear-kda/kda-state-edit.svg){fig-alt="Original KDA state-edit diagram showing channel-wise alpha decay, beta-controlled erase along the key, key-value outer-product write, and query readout"}

*Original diagram based on Equation 10 of the paper.*
...
*Source: [Kimi Linear](https://arxiv.org/abs/2510.26692), Figure 2, page 5; cropped from the vector PDF at approximately 5x/360 DPI.*
...
*Original diagram based on Section 3.2, the paper's appendix algorithms, and FLA's KDA kernel paths.*
...
*Source: [Kimi Linear](https://arxiv.org/abs/2510.26692), Figure 3, page 6; cropped from the vector PDF at approximately 5x/360 DPI.*
...
*Source: [Kimi Linear](https://arxiv.org/abs/2510.26692), Figure 4, page 7; cropped from the vector PDF at approximately 5x/360 DPI.*
...
*Source: [Kimi Linear](https://arxiv.org/abs/2510.26692), Table 1, page 8; cropped from the vector PDF at approximately 5x/360 DPI.*
...
*Source: [Kimi Linear](https://arxiv.org/abs/2510.26692), Figure 5, page 9; cropped from the vector PDF at approximately 5x/360 DPI.*
...
*Source: [Kimi Linear](https://arxiv.org/abs/2510.26692), Table 5, page 12; cropped from the vector PDF at approximately 5x/360 DPI.*
...
*Source: [Kimi Linear](https://arxiv.org/abs/2510.26692), Figure 6, page 12; cropped from the vector PDF at approximately 5x/360 DPI.*
...
*Source: [Kimi Linear](https://arxiv.org/abs/2510.26692), Figure 7, page 13; cropped from the vector PDF at approximately 5x/360 DPI.*
...
FlashKDA pushes kernel optimization further with CUTLASS, chunk size 16, two main kernels, BF16 state storage, and FP32 FMA. The following figure redraws the official H20 table. Across six workloads with $T=8192,d=128$, it reports 1.85–2.31x over FLA KDA. These are operator latencies, not a complete Transformer layer.

![High-resolution redraw of the official FlashKDA H20 benchmark.](../../assets/kimi-linear-kda/flashkda-h20-benchmark.svg){fig-alt="Redraw of the official FlashKDA H20 benchmark listing FLA and FlashKDA latency and speedup for fixed, mixed variable-length, and eight-by-1024 workloads with 96 and 64 heads"}

*Data source: [MoonshotAI/FlashKDA](https://github.com/MoonshotAI/FlashKDA), official H20 benchmark dated 2026-04-22; accessed and redrawn 2026-08-03. No browser instance was available to the screenshot connector, so exact official values are retained and the asset is explicitly labeled as a redraw.*
...
*Source: [Gated DeltaNet-2](https://arxiv.org/abs/2605.22791), Figure 1, page 6; cropped from the vector PDF at approximately 5x/360 DPI.*
