...
For the behavioral-mining, Qwen-cleaning, and 1.5B-distillation design, see [Query Recognition and Rewriting](https://github.com/BrenchCC/Query-Recognition-and-Rewriting).
...
Reranking combines relevance, rewrite confidence, behavioral value, and content quality. The function below computes a linear score; Appendix A supplies weights, features, and filtering examples that can be executed in order:
...
def score_item(features, weights, risk_weight):
    ...
    Args:
        features: Normalized relevance, quality, behavior, and risk features.
        weights: Positive feature names mapped to their coefficients.
