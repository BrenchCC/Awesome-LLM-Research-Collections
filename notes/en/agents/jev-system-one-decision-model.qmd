...
## 7. Known failure modes define the engineering boundary
...
_Figure 8: Original explanatory diagram. Jev fits closed answer spaces whose semantic judgment is hard to hand-code. Exact rules belong in code, open creation belongs in a generative model, and high-risk decisions with retained duty remain under human approval._

## 8. My assessment: the value is interface discipline, not a mysterious architecture
