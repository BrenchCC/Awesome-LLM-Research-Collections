...
title: "A Comprehensive Guide to RSI (Self-Evolution, Self-Evolving Agents)"
...
![An RSI taxonomy](../../assets/rsi-guide/codex-rsi-taxonomy-overview-gpt-en.png)

![RSI works by improvement target and update timing](../../assets/rsi-guide/codex-rsi-artifact-mode-matrix-en.png)
...
![The basic RSI loop](../../assets/rsi-guide/codex-rsi-loop-en.png)
...
![Agent anatomy and major improvement targets](../../assets/rsi-guide/codex-agent-anatomy-en.png)
...
![Chain, tree, and graph evolution topologies](../../assets/rsi-guide/codex-evolution-topologies-en.png)
...
![Self-update](../../assets/rsi-guide/codex-self-update-en.png)
...
![Teacher update](../../assets/rsi-guide/codex-teacher-update-en.png)
...
![Joint update](../../assets/rsi-guide/codex-joint-update-en.png)
...
![Offline, online, and hybrid RSI](../../assets/rsi-guide/codex-rsi-update-timing-en.png)
