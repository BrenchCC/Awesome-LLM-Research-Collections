...
![OpenAI's published GPT‑5.6 self-improvement scores. Redrawn from the official July 2026 release, accessed 2026-08-21; all values come from OpenAI's internal or official evaluation configurations.](../../assets/recursive-self-improvement/openai-rsi-index-redraw.svg){width="92%" fig-align="center"}
...
![Anthropic's five stages of AI-development automation. Official page screenshot, accessed 2026-08-21; “20XX?” explicitly places closing the loop in the future.](../../assets/recursive-self-improvement/anthropic-rsi-timeline.png){width="62%" fig-align="center"}
...
![The original three optimization targets: models, harnesses, and artifacts. Preserved source image; it classifies the target, not the depth of loop closure.](../../assets/recursive-self-improvement/three-object-taxonomy.png){width="72%" fig-align="center"}
...
![An Autoresearch run records candidate changes, fixed training budgets, validation scores, and keep/discard decisions. Preserved source image from a public project run.](../../assets/recursive-self-improvement/autoresearch-run.png){width="92%" fig-align="center"}
...
![AlphaEvolve samples prior programs, generates candidates with an LLM, evaluates them automatically, and writes survivors back to an evolutionary database. Preserved image from the Google DeepMind blog.](../../assets/recursive-self-improvement/alphaevolve-loop.webp){width="92%" fig-align="center"}
...
![Harness-updating and harness-benefit behave differently. The preserved source plot is relatively flat on update proposals and non-monotonic on realized benefit.](../../assets/recursive-self-improvement/harness-updating-benefit.png){width="92%" fig-align="center"}
...
![MiniMax's M2 research harness connects skills, memory, guardrails, and evaluation infrastructure to an experiment-iteration loop. Preserved source image from the official release.](../../assets/recursive-self-improvement/minimax-m27-recursive-loop.png){width="90%" fig-align="center"}
...
![The Apodex‑1.0 multi-agent research and verification architecture. Preserved source image from the Apodex blog.](../../assets/recursive-self-improvement/apodex-agent-team.avif){width="88%" fig-align="center"}
...
![RHI runs the current harness, compares outputs, accumulates preference history, and produces the next harness. Preserved source image from RHI v1, Figure 2.](../../assets/recursive-self-improvement/rhi-loop.png){width="90%" fig-align="center"}
...
![RHI decomposes a harness into Agent Design and an Agent Workflow containing Contract and Hop. Preserved source image from RHI v1.](../../assets/recursive-self-improvement/rhi-harness-structure.png){width="84%" fig-align="center"}
...
![Budget-matched Terminal‑Bench 2.1 results. The low-resolution source is displayed narrowly; source: Ai2 paper v1.](../../assets/recursive-self-improvement/harness-evolution-budget-baselines.png){width="42%" fig-align="center"}
...
![AIDE² rewrites the inner agent and admits only candidates that beat the incumbent. Preserved image from Weco AI's experimental report.](../../assets/recursive-self-improvement/aide2-self-improvement.png){width="92%" fig-align="center"}
...
![RHO turns past trajectories into harness updates. Source: RHO v2, Figure 2; cropped from a 220-DPI rendering of the paper PDF.](../../assets/recursive-self-improvement/rho-retrospective-harness-pipeline.png){width="94%" fig-align="center"}
...
![HSI's three levels—Meta-Evolver, Evolver, and Task Harness—share a file system but expose distinct editable surfaces. Source: HSI v1, Figure 1; cropped from a 220-DPI PDF render.](../../assets/recursive-self-improvement/hsi-three-level-architecture.png){width="94%" fig-align="center"}
...
![SIA exposes two update levers: harness and model weights. Preserved source image from SIA v2.](../../assets/recursive-self-improvement/sia-two-update-levers.png){width="90%" fig-align="center"}

![The SIA loop: a Meta-Agent initializes the scaffold, a task agent acts, and a Feedback-Agent chooses between harness and weight updates. Preserved source image from SIA v2.](../../assets/recursive-self-improvement/sia-system-loop.png){width="90%" fig-align="center"}
...
![Continual Harness updates the harness rapidly within a run and updates the model across rounds through process rewards and teacher trajectories. Preserved source image from paper v1.](../../assets/recursive-self-improvement/continual-harness.png){width="94%" fig-align="center"}
...
![HELIX's two timescales: model–harness interaction within tasks, and cross-round model updates from verified sibling data followed by harness rebuilding. Source: HELIX v1, Figure 1; cropped from a 220-DPI PDF render.](../../assets/recursive-self-improvement/helix-two-timescales.png){width="94%" fig-align="center"}
...
![Per-token teacher confidence in on-policy distillation. Preserved SVG from the Thinking Machines blog.](../../assets/recursive-self-improvement/on-policy-distillation-token-confidence.svg){width="72%" fig-align="center"}
...
![Accuracy of Coconut, CoT, extended CoT, and No-CoT on graph reachability. The low-resolution source is displayed narrowly; source: Reasoning by Superposition.](../../assets/recursive-self-improvement/reasoning-by-superposition-results.png){width="38%" fig-align="center"}
